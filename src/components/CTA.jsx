                ...
                <div className="relative rounded-3xl overflow-hidden p-[1px] group">
                    ...
                    <div className="bg-[#0A051A] bg-opacity-90 backdrop-blur-xl relative rounded-3xl px-8 py-20 md:py-28 text-center overlow-hidden">
                        ...
                        <div className="relative z-10">
                            <button className="bg-white text-black px-8 py-4 rounded-full font-bold text-md cursor-pointer hover:bg-gray-100 hover:-translate-y-1 transition-all duration-300 shadow-[0_10px_30px_-10px_rgba(255,255,255,0.4)] flex items-center gap-3 mx-auto group/btn">
