    ...
    const servicesData = [
        {
            ...
            tag: "Design",
            title: "UI/UX Design",
            description: "Seamless, user-centered interfaces that boost engagement and retention."
        },
        {
            icon: (
                <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
            ...
            description: "Building robust and scalable web applications with modern technologies and frameworks."
        },
        {
            icon: (
                <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
