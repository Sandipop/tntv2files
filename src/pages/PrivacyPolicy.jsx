...
const PrivacyPolicy = () => {
    return (
        <div className='bg-[#060010] min-h-screen text-gray-300 pb-20'>
            <NextHero
                title="Privacy"
                subtext="Your privacy is important to us. This policy outlines how we collect, use, and protect your personal information."
            />
                ...
                <div className="space-y-12">
                    ...
                    <section>
                        ...
                        <p className="leading-relaxed text-gray-400">
                            Welcome to Tagntarget. We respect your privacy and are committed to protecting your personal data.
                    ...
                    <section>
                        ...
                        <p className="leading-relaxed text-gray-400">
                            If you have any questions about this privacy policy or our privacy practices, please contact us at: <a href="mailto:info@tagntarget.com" className="text-blue-400 hover:underline">info@tagntarget.com</a>.
                        </p>
                    </section>
