...
const ServicePage = () => {
  return (
    <div>
      <NextHero
        title="Services"
        subtext="“From UI/UX and branding to UX audits and software development—we deliver end-to-end solutions that fuel your growth.”"
      />
      <Services headerAlignment="center" />
      <WorkingSmarter 
    alignment="Left" 
    imageSrc="..." 
    title="..."
